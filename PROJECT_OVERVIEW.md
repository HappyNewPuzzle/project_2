...
26단계 공용·사용자 소유 캐릭터 목록 조회와 선택
27단계 사용자 소유 캐릭터 수정·삭제와 충돌 안내
...
- 로그인
- 캐릭터 생성
- 공용·사용자 소유 캐릭터 목록 조회와 선택
- 사용자 소유 캐릭터 상세 설정 수정과 확인 후 삭제
- 장기 기억 직접 작성, 전역·캐릭터 범위 필터, 활성화와 삭제
- 자연어 기억 검색, cosine 유사도 순위와 제한적 재색인
- 기억 저장
- 스트리밍 채팅
- 대화 목록 새로고침
- 첫 메시지 기반 대화방 제목 표시
...
26단계: 기존 캐릭터 목록 조회·선택 UI (완료)
27단계: 사용자 소유 캐릭터 수정·삭제 UI (완료)
28단계: 장기 기억 목록·작성·활성화·삭제 UI (완료)
29단계: 장기 기억 의미 검색·재색인 UI (완료)
30단계: 로그아웃·토큰 만료·401 인증 상태 초기화
```
