...
2. 회원가입 후 로그인합니다.
3. 캐릭터를 생성합니다.
4. 또는 캐릭터 목록에서 공용·기존 캐릭터를 선택합니다.
5. 내 캐릭터라면 상세 설정을 수정하거나 삭제할 수 있습니다.
6. 필요하면 테스트 장기 기억을 저장합니다.
7. 메시지를 보내 토큰 단위 스트리밍을 확인합니다.
8. 대화 목록을 새로고침해 이전 대화를 열거나 삭제합니다.
...
- 장기 기억은 고정 테스트 문구만 저장할 수 있고 목록 관리 UI가 없습니다.
