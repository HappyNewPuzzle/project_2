...
19. [18단계: Redis 기반 rate limit 준비](step-18-redis-rate-limit.md)
20. [19단계: 장기 기억 자동 추출 구조](step-19-auto-memory-extraction.md)
21. [20단계: embedding / pgvector 검색 준비](step-20-embedding-pgvector-readiness.md)
