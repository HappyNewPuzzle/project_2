...
프로젝트 전체 현황은 [프로젝트 종합 설명서](../PROJECT_OVERVIEW.md)에 정리했습니다.

## 현재 단계

30단계까지 구현되어 있습니다. Docker Compose로 API와 pgvector PostgreSQL을 함께 실행하고,
...
- 인증 세션 UX: 로그아웃, 보호 API 401 감지와 사용자 화면 상태 초기화
